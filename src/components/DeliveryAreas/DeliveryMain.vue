...
<template>
  ...
  >
    ...
    <div
      class="flex-col gap-5 text-content-md md:text-content-sm lg:text-content-md xl:text-content text-textColor md:text-start w-[22rem] md:w-[18.75rem] lg:w-[20.625rem] xl:w-[26.312rem] flex shrink"
    >
