...
const styleClasses = computed(() => {
  return reviews.value.map((review, index) => {
    const styles = [
      "text-red-600 ml-[25%] 2xl:ml-[35%]",
      "text-green-600 ml-[15.5%] 2xl:ml-[25.5%]",
      "text-purple-600 ml-[23%] 2xl:ml-[33%]",
      "text-orange-600 ml-[17.3%] 2xl:ml-[27.3%]",
    ];
...
<template>
  <section class="container justify-center mx-auto mt-28">
    ...
    <div
      ...
      :key="review.id"
      class="flex flex-col mt-10 items-end w-[49rem] text-content min-h-[13.375rem]"
    ...
    >
      ...
      >
       <div class="flex items-center justify-center place-self-start w-16 h-16">
        ...
        <p class="w-[40.125rem] mx-10">{{ review.description }}</p>
